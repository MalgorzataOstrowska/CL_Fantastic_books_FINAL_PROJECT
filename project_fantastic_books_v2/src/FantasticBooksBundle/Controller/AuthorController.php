...
class AuthorController extends Controller
{
     ...
     *
     * @Route("/", name="editor_author_index")
     * @Method("GET")
     */
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('FantasticBooksBundle:Author')->findAll();
     ...
     *
     * @Route("/new", name="editor_author_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        $author = new Author();
        $form = $this->createForm('FantasticBooksBundle\Form\AuthorType', $author);
     ...
     *
     * @Route("/{id}", name="editor_author_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="editor_author_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Author $author)
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('FantasticBooksBundle\Form\AuthorType', $author);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('editor_author_edit', array('id' => $author->getId()));
        }
     ...
     *
     * @Route("/{id}", name="editor_author_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Author $author)
    {
        ...
        return $this->redirectToRoute('editor_author_index');
    }
    ...
    private function createDeleteForm(Author $author)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('editor_author_delete', array('id' => $author->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
